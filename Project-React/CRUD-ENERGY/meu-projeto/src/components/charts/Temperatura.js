  ...
  return (
    <>
      ...
      >
        ...
        <Line id="c5" class="linhas_ocultas" type="monotone" dataKey="temperatura_C" stroke="#E64A19" activeDot={{ r: 8 }} />
      </LineChart>
    </>
  );
}

export default TemperaturaCharts;
